...
if (isset($_REQUEST['firstname'])) {
  if ($_REQUEST['password'] == $_REQUEST['confirm_password']) {
    ...
    $error = "ERROR: Please Check Your Password & Confirmation password";
  }
}
?>
<!DOCTYPE html>
...
<body>
  <div class="signup-form">
    <?php if (!empty($error)): ?>
    <div class="alert text-danger mb-3 p-3" style="border-radius: 0.25rem; background-color: #f8d7da; border: 1px solid #f5c6cb; margin-bottom:15px;">
